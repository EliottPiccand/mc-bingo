...
execute as @a[team=orange] run scoreboard players add temp_orange calculator 1
...
execute as @a[team=rose] run scoreboard players add temp_rose calculator 1
...
execute as @a[team=vert] run scoreboard players add temp_vert calculator 1
