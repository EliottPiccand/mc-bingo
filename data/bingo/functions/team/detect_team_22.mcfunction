...
execute if score temp_bleu calculator matches ..1 if score bleu_count calculator matches 2.. run advancement grant @a[team=bleu] only bingo:team/team_22
...
execute if score temp_orange calculator matches ..1 if score orange_count calculator matches 2.. run advancement grant @a[team=orange] only bingo:team/team_22
...
execute if score temp_rose calculator matches ..1 if score rose_count calculator matches 2.. run advancement grant @a[team=rose] only bingo:team/team_22
...
execute if score temp_vert calculator matches ..1 if score vert_count calculator matches 2.. run advancement grant @a[team=vert] only bingo:team/team_22
