...
execute if entity @s[team=vert] run advancement grant @s only bingo:taupe/taupe_14 4
advancement revoke @a only bingo:detection_taupe_14/fill_lava_cauldron
